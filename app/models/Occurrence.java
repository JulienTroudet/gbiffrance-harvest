...
public class Occurrence extends Model
{
  ...
  public boolean inCountriesList(String value) {
	  ...
	  for (String country : countriesList)
		  if (country.equals(value)) return true;
	  return false;
  }
  ...
  public boolean inBoundingBoxList(Float decimalLatitude, Float decimalLongitude) {
	  ...
	  for (int i = 0; i < BoundingBoxesList.size(); ++i) {
		  if (decimalLatitude > BoundingBoxesList.get(i)[0] && decimalLatitude < BoundingBoxesList.get(i)[1]
			&& decimalLongitude > BoundingBoxesList.get(i)[2] && decimalLongitude  < BoundingBoxesList.get(i)[3]) return true;
	  }
	  return false;
  }
